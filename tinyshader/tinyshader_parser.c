...
static AstExpr *parseAccessFuncCall(Parser *p)
{
    ...
    case TOKEN_BUILTIN_FRAC:
        ...
        expr_kind = EXPR_BUILTIN_CALL;
        break;
    case TOKEN_BUILTIN_TRUNC:
        builtin_kind = IR_BUILTIN_TRUNC;
        expr_kind = EXPR_BUILTIN_CALL;
        break;
    case TOKEN_BUILTIN_CEIL:
        builtin_kind = IR_BUILTIN_CEIL;
        expr_kind = EXPR_BUILTIN_CALL;
        break;
    case TOKEN_BUILTIN_FLOOR:
        builtin_kind = IR_BUILTIN_FLOOR;
        expr_kind = EXPR_BUILTIN_CALL;
        break;
    ...
    case TOKEN_BUILTIN_ASUINT:
        builtin_kind = IR_BUILTIN_ASUINT;
        expr_kind = EXPR_BUILTIN_CALL;
        break;
    case TOKEN_BUILTIN_ASINT:
        builtin_kind = IR_BUILTIN_ASINT;
        expr_kind = EXPR_BUILTIN_CALL;
        break;
    case TOKEN_BUILTIN_ASFLOAT:
        builtin_kind = IR_BUILTIN_ASFLOAT;
        expr_kind = EXPR_BUILTIN_CALL;
        break;

    case TOKEN_BUILTIN_INTERLOCKED_ADD:
        builtin_kind = IR_BUILTIN_INTERLOCKED_ADD;
        expr_kind = EXPR_BUILTIN_CALL;
        break;
    case TOKEN_BUILTIN_INTERLOCKED_AND:
    ...
    case TOKEN_BUILTIN_INTERLOCKED_MAX:
        ...
        expr_kind = EXPR_BUILTIN_CALL;
        break;
    case TOKEN_BUILTIN_INTERLOCKED_OR:
        builtin_kind = IR_BUILTIN_INTERLOCKED_OR;
        expr_kind = EXPR_BUILTIN_CALL;
        break;
    case TOKEN_BUILTIN_INTERLOCKED_XOR:
        builtin_kind = IR_BUILTIN_INTERLOCKED_XOR;
        expr_kind = EXPR_BUILTIN_CALL;
        break;
    case TOKEN_BUILTIN_INTERLOCKED_EXCHANGE:
